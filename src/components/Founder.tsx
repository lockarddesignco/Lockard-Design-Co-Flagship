...
const Founder: React.FC = () => {
  // Primary image path (Local file)
  const localImage = "/will_lockard.jpg";
  // Fallback image (High-quality B&W placeholder)
  const fallbackImage = "https://images.unsplash.com/photo-1556157382-97eda2d62296?q=80&w=800&auto=format&fit=crop&saturation=-100";
